                                  ...
                                  <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                      <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">
                                        ...
                                        <img align="center" border="0" src="https://assets.unlayer.com/projects/222594/1710489220140-logo.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 24px;"
                                          width="24" />
                              ...
                              <tr>
                                <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;" align="left">
                                  ...
                                  <div class="v-text-align" style="font-size: 14px; line-height: 10%; text-align: center; word-wrap: break-word;">
                                    <p style="line-height: 10%;"><span style="font-size: 20px; line-height: 2px; font-family: 'arial black', AvenirNext-Heavy, 'avant garde', arial;">${otpToken}</span></p>
                                  </div>
                              ...
                              <tr>
                                <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;" align="left">
                                  ...
                                  <div class="v-text-align" style="font-size: 14px; color: #fafafa; line-height: 180%; text-align: center; word-wrap: break-word;">
                                    <p style="font-size: 14px; line-height: 180%;"><span style="font-size: 16px; line-height: 28.8px;">Copyrights © forwardin ads digital partner</span></p>
                                  </div>
