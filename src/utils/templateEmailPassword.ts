export function passwordTemplate(password: string, name: string) {
                    ...
                    <div class="u-col u-col-100" style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
                      <div style="height: 100%;width: 100% !important;">
                        ...
                        <div style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;">
                          ...
                          <table id="u_content_image_8" style="font-family:'Cabin',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                            <tbody>
                              <tr>
                                  ...
                                  <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                      <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">
                                        ...
                                        <img align="center" border="0" src="https://assets.unlayer.com/projects/222594/1711351154041-logo.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 24px;"
                                          width="24" />
                      ...
                      <div style="height: 100%;width: 100% !important;">
                        ...
                        <div style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;">
                          ...
                          <table id="u_content_text_6" style="font-family:'Cabin',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                            <tbody>
                              <tr>
                                <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:20px 55px 10px;font-family:'Cabin',sans-serif;" align="left">
                                  ...
                                  <div class="v-text-align" style="font-size: 14px; line-height: 160%; text-align: left; word-wrap: break-word;">
                                    ...
                                    <p style="font-size: 14px; line-height: 160%;">We are pleased to inform you that an account has been successfully created for you. Below are your account password:</p>
                                  </div>
                              ...
                              <tr>
                                <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;" align="left">
                                  ...
                                  <div class="v-text-align" style="font-size: 14px; line-height: 10%; text-align: center; word-wrap: break-word;">
                                    ...
                                    <p style="line-height: 10%;"><strong><span style="font-size: 20px; line-height: 2px; font-family: 'arial black', AvenirNext-Heavy, 'avant garde', arial;">${password}</span></strong></p>
                                    <p style="line-height: 10%;">&nbsp;</p>
                                  </div>
                              ...
                              <tr>
                                <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;" align="left">
                                  ...
                                  <div class="v-text-align" style="font-size: 14px; color: #fafafa; line-height: 180%; text-align: center; word-wrap: break-word;">
                                    <p style="font-size: 14px; line-height: 180%;"><span style="font-size: 16px; line-height: 28.8px;">Copyrights © Forwardin </span></p>
                                  </div>
